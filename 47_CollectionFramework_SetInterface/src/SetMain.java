...
public class SetMain {
  ...
  /*
    ...
    3. Elementlerin ekleme sırasına göre depolanmaz.
 ...
 /* Set<String> set1 = new HashSet<String>();
    ...
    set3.add("Javascript");
    set3.add("Php");
    set3.add("Php");  // eklemez aynisini  digerleri de ayni boyle 
  */
  /*System.out.println("HashSet*******************************");  //karisik sekilde bastiracak
    for (String s: set1){
        System.out.println(s);
    }
    System.out.println("LinkedHashSet*******************************");  //yazdigimiz sira ile bastiracak
    for (String s: set2){
        System.out.println(s);
    }
    System.out.println("TreeSet*******************************");   //alfabetik olarak bastiracak
    for (String s: set3){
        System.out.println(s);
    }*/
    //System.out.println(set1.contains("Go"));   //.contains() metodu: iceriyor mu bulmak icin iceriyorsa true doner.
    //System.out.println(set1.contains("Java"));
        
    //set1.remove("Java");   //set1 den Java yi silmek icin.
   ...
   Set<String> fark = new HashSet<String>(set2);
        ...
        System.out.println(fark.removeAll(set1));  //set1 ve set2 de ayni olanlari cıkardi.( set2-set1 )
        System.out.println(fark);                // CSS ve Go basacak.
  
    Set<String> kesisim = new HashSet<String>(set2);
        System.out.println(kesisim.retainAll(set1));   //kesisim kumesi var mı?
        System.out.println(kesisim);    // Java basar.
    }
}
