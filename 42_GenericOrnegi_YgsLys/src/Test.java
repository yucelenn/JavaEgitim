...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (islem.equals("1")){
                ...
                EsitAgirlik birincii = birinci(ogrenci1,ogrenci2, ogrenci3);
                
                System.out.println("Birinci Eşit Ağırlık Öğrencisi : " + birincii.getIsim());
                System.out.println("Öğrenci Puanı : " + birincii.puanHesapla());               
            }
                ...
                Sayisal birinciii = birinci(ogrenci1,ogrenci2, ogrenci3);
                
                System.out.println("Birinci Sayısal Öğrencisi : " + birinciii.getIsim());
                System.out.println("Öğrenci Puanı : " + birinciii.puanHesapla());
            }
            else {
    ...
    public static <E extends Aday> E birinci(E e1,E e2,E e3) {   // Generic metod
